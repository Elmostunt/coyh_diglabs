...
function DataMockup() {
  return (
    <div className="relative select-none">
      <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-cyan-50 via-slate-50 to-blue-50/40 dark:from-cyan-950/40 dark:via-slate-800/40 dark:to-blue-950/20" />
  ...
  return (
    <div className="w-full">
      ...
      <section className="bg-white dark:bg-slate-900 py-16 sm:py-20 border-b border-slate-100 dark:border-slate-700">
        <div className="mx-auto w-full max-w-6xl px-4 sm:px-6">
          <div className="mb-5 flex items-center gap-3">
            ...
            <span className="text-sm font-medium text-slate-500 dark:text-slate-400">Datos & Analítica</span>
          </div>
      ...
      <section className="bg-slate-50 dark:bg-slate-800 py-14 sm:py-16">
        <div className="mx-auto w-full max-w-6xl px-4 sm:px-6">
          <div className="text-center mb-10">
            <h2 className="text-2xl sm:text-3xl font-bold text-slate-950 dark:text-white">Packs de Datos</h2>
      ...
      <section className="bg-white dark:bg-slate-900 py-14 sm:py-16">
        <div className="mx-auto w-full max-w-6xl px-4 sm:px-6">
          <div className="max-w-xl mb-10">
            ...
            <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">Las capacidades que aplicamos en cada proyecto de datos</p>
          </div>
      ...
      <section className="border-y border-slate-100 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 py-8">
        <div className="mx-auto w-full max-w-6xl px-4 sm:px-6">
          <p className="text-center text-xs font-semibold uppercase tracking-widest text-slate-400 dark:text-slate-500 mb-5">
      ...
      <section className="bg-white dark:bg-slate-900 py-14 sm:py-16">
        <div className="mx-auto w-full max-w-6xl px-4 sm:px-6">
          <div className="max-w-xl mb-10">
            ...
            <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">Todo el alcance del área de Datos & Analítica</p>
          </div>
